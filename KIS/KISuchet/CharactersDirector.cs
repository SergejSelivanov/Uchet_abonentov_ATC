...
{
    public partial class CharactersDirector : Form
    {
        public CharactersDirector()
        {
            InitializeComponent();
            ft_update1();
        }
        private void ft_update1()
        {
            ...
            List<string[]> data = new List<string[]>();                               //предоставление информации для директора
            while (reader.Read())
            {
        ...
        private void CharactersDirector_Load(object sender, EventArgs e)
        {
