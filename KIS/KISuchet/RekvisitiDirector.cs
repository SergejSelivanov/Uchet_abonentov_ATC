...
{
    public partial class RekvisitiDirector : Form
    {
        public RekvisitiDirector()
        {
            InitializeComponent();
            ft_update1();
        }
        ...
        {
            DirectorForm fr2 = new DirectorForm();                               //переход на форму директора
            fr2.Show();
            Hide();
        }
        ...
        private void RekvisitiDirector_Load(object sender, EventArgs e)
        {
